...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivSplashLogo,
      @NonNull TextView tvSplashName, @NonNull TextView tvSplashTagline) {
    this.rootView = rootView;
    this.ivSplashLogo = ivSplashLogo;
    this.tvSplashName = tvSplashName;
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvSplashName;
      TextView tvSplashName = ViewBindings.findChildViewById(rootView, id);
      if (tvSplashName == null) {
        break missingId;
      }
      ...
      return new ActivitySplashBinding((LinearLayout) rootView, ivSplashLogo, tvSplashName,
          tvSplashTagline);
    }
